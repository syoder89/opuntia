...
This is one of the reasons why Opuntia and other firmware exists: providing a 
...
OS details: Linksys WRT54GS v4 running Opuntia w/Linux kernel 2.4.30
...
80/tcp open  http    Opuntia BusyBox httpd
MAC Address: 00:13:xx:xx:xx:xx (Cisco-Linksys)
...
Opuntia does not currently run on devices which have 2MB or less of flash memory.
...
\subsection{Adding your target in Opuntia}

Once you spotted the key changes that were made to the Linux kernel
to support your target, you will want to create a target in Opuntia
for your hardware. This can be useful to benefit from the toolchain
that Opuntia builds as well as the resulting user-space and kernel
configuration options.

Provided that your target is already known to Opuntia, it will be
