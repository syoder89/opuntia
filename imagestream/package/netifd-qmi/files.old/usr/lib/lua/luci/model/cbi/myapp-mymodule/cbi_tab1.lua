...
m = Map("cbi_file1", translate("Modem Support"), translate("Add Support for a Modem"))
...
e = m:section(TypedSection, "new", "New Modem Settings")   
...
p3 = e:option(ListValue, "port", "Data Port :")
