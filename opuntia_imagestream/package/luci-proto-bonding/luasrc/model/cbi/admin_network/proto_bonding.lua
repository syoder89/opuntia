...
local function get_selectable_slaves_from_proc(field)
	interfaces = SYS.exec("cat /proc/net/dev | grep '^[[:space:]]*eth' | awk '\{print \$1\}' | tr ':\n' ' '")
...
-- This creates a list and also can't really filter interfaces properly
--slaves = section:taboption("general", Value, "slaves",
...
--slaves.template  = "cbi/network_ifacelist"
--slaves.oneline = true
--slaves.nobridges = true
--slaves.noaliases = true
--slaves.nocreate = true

slaves = section:taboption("general", MultiValue, "slaves",
        translate ("Slave Interfaces"),
        translate("Specifies which slave interfaces should be attached to this bonding interface"))
slaves.size = 1
slaves.widget = "select"
...
bonding_policy.default = "802.3ad"
...
min_links.optional = true
min_links.datatype = "uinteger"
min_links.placeholder = 0
...
ad_actor_sys_prio.optional = true
ad_actor_sys_prio.placeholder = 65535
...
packets_per_slave.placeholder= 1
packets_per_slave.optional = true
...
lp_interval.placeholder = 1
lp_interval.optional = true
...
tlb_dynamic_lb.placeholder = "1"
tlb_dynamic_lb.optional = true
...
xmit_hash_policy.default = "layer3+4"
...
xmit_hash_policy:depends("bonding_policy", "802.3ad")
...
all_slaves_active.default = ""
all_slaves_active.optional = true
