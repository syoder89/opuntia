...
local proto = netmod:register_protocol("ndis")

function proto.get_i18n(self)
	return luci.i18n.translate("NDIS")
end
...
function proto.is_installed(self)
	return nixio.fs.access("/lib/netifd/proto/ndis.sh")
end
...
netmod:register_pattern_virtual("^ndis-%w")
