...
void unlink_if(stat_if **head, stat_if **tail, stat_if *stat)
{
	if (stat->prev)
...
int ifaces_alpha_sort_cmp(stat_if *cmp, stat_if *stat, int ascending)
{
	int retval;
...
int ifaces_description_sort_cmp(stat_if *cmp, stat_if *stat, int ascending)
{
...
int ifaces_encapsulation_sort_cmp(stat_if *cmp, stat_if *stat, int ascending)
{
...
int ifaces_bandwidth_sort_cmp(stat_if *cmp, stat_if *stat, int ascending)
{
...
int ifaces_hw_status_sort_cmp(stat_if *cmp, stat_if *stat, int ascending)
{
...
int ifaces_proto_status_sort_cmp(stat_if *cmp, stat_if *stat, int ascending)
{
	int cmp_status, stat_status;
...
int ifaces_inusage_sort_cmp(stat_if *cmp, stat_if *stat, int ascending)
{
...
int ifaces_outusage_sort_cmp(stat_if *cmp, stat_if *stat, int ascending)
{
...
int ifaces_inoutusage_sort_cmp(stat_if *cmp, stat_if *stat, int ascending)
{
	int cmp_status = percent(&(cmp->rx.byte), cmp->bandwidth, getRealInterval(cmp)) +
